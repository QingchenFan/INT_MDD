...
'''
组水平 INT 映射到脑图展示，查看 pattern。组水平数据存放到 mat文件中
'''
...
data = sio.loadmat("/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZII/INT_value/INT_MDDGroup/Group.mat")['hwhm']
...
scalar_img.to_filename('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZII/Step1_GroupMapBrain_BNA246/INT_MDD.dscalar.nii')
