...
# 1. 数据读取与准备
path_base = '/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/INT_verify/Step6_slope_Diff/'
df_hc = pd.read_csv(path_base + 'HC_DZ_INT_slopes.csv')
df1 = pd.read_csv(path_base + 'subtype1_DZ_INT_slopes.csv')
df2 = pd.read_csv(path_base + 'subtype2_DZ_INT_slopes.csv')
