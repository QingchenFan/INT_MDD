...
# 1. 读取数据
df = pd.read_csv("/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/INT_verify/subtype2_DZ_INT_8net.csv")
...
final_df.to_csv("/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/INT_verify/Step6_slope_Diff/subtype2_DZ_INT_slopes.csv", index=False)
