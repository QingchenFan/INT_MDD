import numpy as np
import pandas as pd
from sklearn.cross_decomposition import PLSRegression      # ← 新增：PLSR
...
def plsr_cv(X, y, C=None, n_splits=5, n_runs=50, control_covariates=True):
    """
    ...
    for run in range(n_runs):
        ...
        for train_index, test_index in kf.split(X):
            ...
            # ==========================================
            model = PLSRegression(n_components=10)   # 关键参数！建议 5~20 之间
