...
# 1. 读取数据
# ==========================================
base_dir = '/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step1_INTRange/Step2_8Net_INTRange/'
df1 = pd.read_csv(base_dir + 'subtype1_net_range.csv')
df2 = pd.read_csv(base_dir + 'subtype2_net_range.csv')
...
# 保存并展示图片
save_path = base_dir + 'subtype1_subtype2_range_difference.png'
