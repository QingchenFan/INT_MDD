...
# 1. 读取数据
df = pd.read_csv("/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step10_7NetINT_HAMD_Correlation/subtype2_INT_7net_HAMD_t.csv")
...
plt.tight_layout()
plt.savefig('s2_hamd_networks_correlation2.png', dpi=300)
plt.show()