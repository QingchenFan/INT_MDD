...
# ===================== 1. 读取数据 =====================
df = pd.read_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/subtype2_INT_GMV_7net2.csv')
...
#result_df.to_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step4_INT_GMV_Correlation/s2_INT_GMV_correlation_results.csv', index=False, encoding='utf-8-sig')
...
# ===================== 7. 保存图片（已删除 plt.show()） =====================
#plt.savefig('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step4_INT_GMV_Correlation/s2_INT_GMV_Correlation_8net.png', dpi=300, bbox_inches='tight')
plt.close()  # 关闭图形释放内存
