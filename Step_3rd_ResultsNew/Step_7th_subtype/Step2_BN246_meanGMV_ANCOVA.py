...
# =========================================================
# 1. 读取文件与数据合并 (请修改为你自己的绝对路径)
# =========================================================
df_hc = pd.read_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step3_cGMVmean_Diff/HC_GrayVol246.csv')
...
print(anova_table)
anova_table.to_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step3_cGMVmean_Diff/ANCOVA_mean_GMV_MainEffect.csv')
...
# 保存事后检验详细结果
pairwise_df.to_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step3_cGMVmean_Diff/ANCOVA_mean_GMV_Pairwise.csv', index=False)
print("\n========== 事后两两比较 (FDR 校正) ==========")
print(pairwise_df)
...
sns.boxplot(x='group', y='mean_GMV', data=df, order=['HC', 'Subtype1', 'Subtype2'], palette='Set3')
...
plt.title('Comparison of mean_GMV across groups\n(Covariates: Age, Sex, TIV)', fontsize=14, pad=15)
plt.ylabel('Mean Gray Matter Volume (mean_GMV)', fontsize=12)
plt.xlabel('Group', fontsize=12)
plt.tight_layout()

# 保存并展示图片
img_save_path = '/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step3_cGMVmean_Diff/ANCOVA_mean_GMV_Boxplot_Stars.png'
