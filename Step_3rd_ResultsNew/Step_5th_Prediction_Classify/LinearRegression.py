...
def get_xyc(data, ymark):
    ...
    X = data.iloc[:, 6:].values  # 转为 numpy 数组
...
if __name__ == '__main__':
    file_path = '/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step4_subtype/Step5_HAMD_Prediction/subtype1_INT7Net_HAMD.csv'
    ...
    # 个性化设置区
    # ==========================================
    USE_COVARIATES = True  # 改为 False 即可运行【不控制】协变量的版本
    # ==========================================
