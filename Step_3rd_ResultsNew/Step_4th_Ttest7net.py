...
# ================== 1. 读取数据 ==================
hc_df = pd.read_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/INT_value/HC_INT20_7net.csv')
mdd_df = pd.read_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/INT_value/MDD_INT202_7net.csv')
...
# 保存表格
result_df.to_csv('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step2_Ttest/Ttest_7net20.csv', index=False)
...
plt.tight_layout()
plt.savefig('/Volumes/QC/INT/INT_BN246_HC135BP_MDD135BP_DZIII/Step2_Ttest/Ttest_7net20.png', dpi=300, bbox_inches='tight')
#plt.show()
